...
Последовательность обработки включает структурированное извлечение, построение плана, вызов локальных инструментов, формирование ответа с цитатами, независимый вердикт и программную сверку с gold-разметкой. LLM не исполняет произвольный код, не обращается к интернету и не меняет исходные документы.
