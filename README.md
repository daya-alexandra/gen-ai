...
**API-прогон выполнен частично.** IE, аспекты и MAP сохранены; для остановившейся на лимите длины сводки подготовлено [обновление для продолжения](lab2_resume_update.zip) и [инструкция](lab2_text/recovery/README.md). Итоговая оценка судьи ещё не получена. Реализованы IE, анализ шести аспектов, параллельный Map-Reduce, LLM-as-judge с повторной сводкой и autodiscovery. Вход: 30 явно обозначенных синтетических отзывов. Локальные тесты пройдены.
